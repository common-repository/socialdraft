...
*/
		...
		function calculate(){
				...
				$lastpage = ceil($this->total_pages/$this->limit) - 1;        //lastpage is = total pages / items per page, rounded up.
				//$lastpage = ceil($this->total_pages/$this->limit);        //original: modified with minus 1
